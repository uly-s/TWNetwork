...
namespace TWNetwork.Messages.FromServer
{
    public class ServerAgentTick
    {
        ...
        public ServerAgentTick(Agent agent,Vec3 position, Agent.MovementControlFlag movementFlags, Agent.EventControlFlag eventControlFlags, Vec3 lookDirection, Vec2 movementInputVector)
        {
            this.Agent = agent;
